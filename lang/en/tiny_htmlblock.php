...
$string['maxcatlevels_desc'] = 'When defining HTML blocks below, in the category selector limit the options to some levels only, do not show all categories of any level.';
